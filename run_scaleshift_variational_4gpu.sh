...
build_phase1_jobs() {
  local dataset graph_variant method logname warmup_label cmd
  PHASE1_JOBS=()
  for dataset in "${DATASETS[@]}"; do
    for graph_variant in "${GRAPH_VARIANTS[@]}"; do
      ...
      for method in "${ALL_METHODS[@]}"; do
        ...
        logname="${dataset}_${graph_variant}_${method}_${warmup_label}"
